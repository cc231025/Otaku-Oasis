...
export default function StatusFilterManga(props) {
    ...
    return (
        <div className="relative inline-block text-left w-40 lg:w-52 ">
            ...
            {props.dropdownSelect === "status" && (
                <div
                    className="origin-top-right absolute z-20 left-0  bg-background_lighter rounded-md shadow-lg max-h-80 overflow-y-scroll">
