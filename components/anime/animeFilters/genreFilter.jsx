...
export default function GenreFilter(props) {
    // Based on the options object map through all possible Genre Options and display them in the dropdown
    ...
    // Set the allOptions anew, if the option is already in there, remove it, otherwise add it
